...
| 個別銘柄ダッシュボード | `/stocks/[code]` | ローソク足チャート（MA20/MA50・3M/6M/1Y切替）、出来高、PER/PBR/ROE、6年分の業績推移、AI分析 |
| ウォッチリスト | `/watchlist` | 気になる銘柄の保存先 |
| **スクリーナー** | `/screener` | TOPIX Small 1/2 から売上YoY・利益YoYで成長株を絞り込み |
| 銘柄比較 | `/compare?codes=72030,94320` | 2銘柄を並べて比較 |
| 業界分析 | `/sectors` | 東証33業種別の成長率ランキング、トップグロワー表示 |
| マクロ環境 | `/macro` | 米FF金利・10年米国債・CPI・失業率・USDJPY・WTI原油・米雇用 |
